          ...
          <ul className="mt-4 flex flex-col">
            {highlight && (
              <li className="block h-fit pr-[60px]">
                <a class="text-base-200 mb-5 font-bold hover:text-[#D6DE23] block text-[13px]">
        ...
        >
          <div className="container flex justify-between gap-9 !pr-0">
            <div className="w-full">
              <h5 className="text-[#676767] font-['BeccaPerry'] pb-[17px] leading-[38px] text-[32px] border-b border-base-200 border-dashed">
                {menuItem}
              </h5>
