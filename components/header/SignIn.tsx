...
export function SignInMobile() {
  ...
  return (
    <div
      id={id}
      className="pt-5 pb-[30px] border-b-secondary border-dashed border-b"
    >
      <a href="/login" aria-label="Login">
        <div className="flex gap-[10px] items-center">
          ...
          <p className="text-xs leading-[18px] font-bold text-base-300">
            Olá!, Faça seu <span className="text-primary underline">Login</span>
            {" "}
            ou <span className="text-primary underline">Cadastre-se</span>
          </p>
        </div>
      </a>
      <a href="/account" aria-label="Account" className="hidden">
        <div className="flex gap-[10px] items-center">
          ...
          <p className="text-xs leading-[18px] font-bold text-base-300">
            Olá!, Ir para{" "}
            <span className="text-primary underline">Minha Conta</span>
          </p>
        </div>
      </a>
      <script
