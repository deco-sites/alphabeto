            ...
            <li class="block">
              ...
              <a href={`${ACTION}?${NAME}=${term}`} class="block">
                <span
                  ...
                  class="block text-accent text-[13px] leading-[19.5px] font-medium capitalize hover:text-primary min-w-[158px] pr-[18px]"
                />
              </a>
            </li>
          ))}
...
function TopSearchsMobile({ suggestion, mostSellerTerms }: Props) {
  ...
  const listData: ListItem[] = searches.map(({ term }) => ({
    content: term,
    hightlight: false,
  }));
  ...
  listData.push(
    titleItem,
    ...mostSellerTerms.map((term) => ({ content: term, hightlight: false })),
  );
                ...
                return (
                  <li class="block pt-4 pb-2">
                    <span
                      ...
                      class="block text-primary text-[13px] leading-[19.5px] font-bold capitalize min-w-[133px] pr-[18px]"
                    />
                  </li>
                );
              }
              return (
                <li class="block">
                  ...
                  <a href={`${ACTION}?${NAME}=${content}`} class="block">
                    <span
                      dangerouslySetInnerHTML={{ __html: content }}
                      class="block text-accent text-[13px] leading-[19.5px] font-medium capitalize hover:text-primary min-w-[133px] pr-[18px]"
                    />
                  </a>
                </li>
              );
