...
import {
    ...
    Stars1Mobile,
    Stars2Desktop,
} from "site/components/search/CategoryBottomBanner/Stars.tsx";
...
export default function CategoryBottomBanner(props: Props) {
    return (
        <div class="bg-secondary-content relative">
            ...
            <Stars1Desktop class="absolute mobile:hidden left-0 top-0" />
            <Stars2Desktop class="absolute mobile:hidden bottom-0 right-0" />
            <Stars1Mobile class="absolute desk:hidden top-0 right-0" />
            <Stars2Desktop class="absolute desk:hidden bottom-[339px] right-0" />
        </div>
    );
}
